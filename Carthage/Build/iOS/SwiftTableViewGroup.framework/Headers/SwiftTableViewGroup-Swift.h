...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftTableViewGroup",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC19SwiftTableViewGroup22CollectionViewDelegate")
...
@interface CollectionViewDelegate (SWIFT_EXTENSION(SwiftTableViewGroup)) <UICollectionViewDataSource>
...
@interface CollectionViewDelegate (SWIFT_EXTENSION(SwiftTableViewGroup)) <UICollectionViewDelegateFlowLayout>
...
@interface CollectionViewDelegate (SWIFT_EXTENSION(SwiftTableViewGroup)) <UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC19SwiftTableViewGroup17TableViewDelegate")
...
@interface TableViewDelegate (SWIFT_EXTENSION(SwiftTableViewGroup)) <UITableViewDataSource>
...
@interface TableViewDelegate (SWIFT_EXTENSION(SwiftTableViewGroup)) <UITableViewDelegate>
